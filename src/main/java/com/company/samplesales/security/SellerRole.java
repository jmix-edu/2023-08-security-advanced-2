...
public interface SellerRole extends UiMinimalRole {
    ...
    @ScreenPolicy(screenIds = {"sales_Customer.browse", "sales_Order.browse", "sales_Product.browse", "sales_Customer.edit", "sales_Order.edit", "sales_OrderLine.edit", "sales_Product.edit"})
    void screens();
}